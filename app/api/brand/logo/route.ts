...
export async function POST(req: NextRequest) {
  try {
    const { businessName, tagline, brandTheme, logoPrompt } = await req.json();
...
- Include icon + wordmark text "${businessName}".
- Professional, minimal, startup aesthetic.
- Accessible contrast, transparent background.
- Use clean geometric shapes and readable sans-serif text.`;
